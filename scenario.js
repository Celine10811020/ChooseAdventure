    ...
    {//1
        ...
        options: [
            { text: "嘗試建造一個簡易木橋過河，這樣可以快速前進，但可能會有生命危險。",
              ...
              challenge: "用紙摺出一座橋。<br><a href='#' onclick='showVedio(\"Bridge\"); return false;'>影片範例</a>",
              next: 3 },
    ...
    {//2
        ...
        options: [
            { text: "嘗試建造一個簡易木筏，這樣可以快速前進，但可能會有生命危險。",
              consequence: "食物-2，精力-3，時間+1",
              effects: { food: -2, energy: -3, time: +1 },
              challenge: "用紙摺出一艘船。<br><a href='#' onclick='showImage(\"Boat\"); return false;'>圖片範例</a>",
              next: 5 },
    ...
    {//4
        ...
        options: [
            { text: "抽出腰間的長刀將野豬擊殺，這樣可以獲得額外的食物並確保前方的道路安全。",
              ...
              challenge: "完成野豬圖案的拼圖，代表成功擊殺野豬。<br><a href='./Puzzle/index.html' target='_blank'>野豬拼圖</a>",
              next: 9 },
            { text: "轉身逃跑，確保自己的安全。",
              consequence: "食物-3，精力-3，時間+1",
              effects: { food: -3, energy: -3, time: +1 },
    ...
    {//5
        ...
        options: [
            { text: "幫助他人，義不容辭。",
              ...
              challenge: "陌生人：「我捕獵了一隻山豬，請幫我搬回我家。」並送上1/4的野豬肉做為謝禮<br>完成野豬圖案的拼圖，並獲得食物+5。<br><a href='./Puzzle/index.html' target='_blank'>野豬拼圖</a>",
              next: 11 },
            { text: "無緣無故，拒不相幫。",
    ...
    {//6
        ...
        options: [
            ...
            { text: "冒險探索這個未知的山洞，希望能找到捷徑。",
              consequence: "食物-2，精力-2，時間+1",
              effects: { food: -2, energy: -2, time: +1 },
              challenge: "完成迷宮，走出山洞。<br><a href='./Maze/index.html' target='_blank'>迷宮</a>",
              next: 14 }
        ]
    },
    {//7
    ...
    {//9
        ...
        options: [
            { text: "立即停留在原地休息，並為受傷隊員包扎，雖然會延誤行程，但可以治療受傷的隊員。",
              ...
              challenge: "用三角巾幫受傷隊員完成一個簡易的包扎。<br>經過短暫的休息後，將剛剛獲得的戰利品（野豬）帶上，繼續前往隱霧村。<br><a href='#' onclick='showImage(\"TriangularBandage\"); return false;'>圖片範例</a>",
              next: 19 },
    ...
    {//10
        ...
        options: [
            ...
            { text: "另外尋找一條安全的路線，但這樣會消耗更多的時間。",
              consequence: "食物-2，精力-2，時間+2",
              effects: { food: -2, energy: -2, time: +2 },
              challenge: "完成迷宮，成功找到正確的路徑。<br><a href='./Maze/index.html' target='_blank'>迷宮</a>",
              next: 22 }
        ]
    },
    {//11
    ...
    {//12
        ...
        options: [
            { text: "立即停留在原地休息，並為受傷隊員包扎，雖然會延誤行程，但可以治療受傷的隊員。",
              consequence: "食物-2，精力+1，時間+2",
              effects: { food: -2, energy: +1, time: +2 },
              challenge: "用三角巾幫受傷隊員完成一個簡易的包扎。<br><a href='#' onclick='showImage(\"TriangularBandage\"); return false;'>圖片範例</a>",
              next: 25 },
            { text: "繼續前行，儘快到達目的地，但受傷的隊員可能無法支撐。",
              consequence: "食物-3，精力-3，時間+1",
              effects: { food: -3, energy: -3, time: +1 },
